...
export type CompetitionScorerType =
  | 'FlightMember'
  | 'Caddie'
  | 'HoleSpecific'
  | 'ScorerList'
...
export type BookingAgentTransactionType =
  | 'ChargeToAccount'
  | 'ReverseCharge'
  | 'WalletTopup'
  | 'Refund'
...
export type BookingCommissionStatus =
  | 'None'
  | 'Calculate'
  | 'Recalculate'
  | 'Success'
...
export type TeeTimeBookingStatus =
  | 'Booked'
  | 'Secured'
  | 'CancelledByPlayer'
  | 'CancelledByClub'
...
export type TeeTimeFlightStatus =
  | 'Created'
  | 'Assigned'
  | 'Dispatched'
  | 'PlayStarted'
...
export type RevenueType =
  ...
  | 'StayAndPlay'
  | 'Competition'
  | 'CardMemberCommission';

export type StayAndPlayRequestStatus =
  | 'Draft'
  | 'Generated'
...
export type TransactionTypeUsedFor =
  | 'PricingComponent'
  | 'RoundingAdj'
  | 'Discount'
  | 'CardDiscount'
