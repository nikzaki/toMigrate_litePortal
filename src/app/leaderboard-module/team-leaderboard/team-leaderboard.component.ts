...
export class TeamLeaderboardComponent implements OnInit, OnDestroy {
    ...
    constructor(private activatedRoute: ActivatedRoute,
        ...
        this.ilbColumns           = [{
            id: 'handicap', name: 'Handicap', hidden: false
        }, {
            id: 'team', name: 'Team'
        }, {
            id: 'on', name: 'On'
    ...
    refreshLeaderBoard() {
        if (this.byTeam) {
            let sub = this.compService.getTeamEventScores(this.competitionId,
                this.settingsComp.settings.teamsByGrossOrNet === 'net' ? 'n' : 'g')
                          .subscribe(teamScores => {
                            //   console.log("Team scores sort before : ", teamScores)

                              this.teamScores = teamScores;
                            //   this.teamScores = this.teamScores.sort((a,b) => {
                            //     if(a.topNToPar > b.topNToPar)
                            //         return 1;
                            //     else if(a.topNToPar < b.topNToPar)
                            //         return -1;
                            //     else return 0;
                            // })
            ...
            // console.log("Team scores sort after : ", this.teamScores)
        }
        else {
    ...
    private processTeamScores() {
        ...
        // console.log('processed team scores : ', display)
