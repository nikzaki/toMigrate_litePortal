...
import {LeaderboardSettings, DefaultLeaderboardSettings} from '../../component-module/leaderboard-settings/leaderboard-settings';
...
@Component({
    selector   : 'scorecard-leaderboard',
    templateUrl: './scorecard-leaderboard.component.html',
    styleUrls  : ['./scorecard-leaderboard.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ScorecardLeaderboardComponent implements OnInit,OnChanges, OnDestroy, AfterViewInit {
