...
import {AdminHomePref} from './competition-home-pref';
import {Subscription} from 'rxjs/Subscription';

@Component({
    selector     : 'competition-home',
    templateUrl  : './competition-home.component.html',
    styleUrls    : ['./competition-home.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class CompetitionHome implements OnInit {
    ...
    constructor(private competitionService: CompetitionService,
        ...
        let pref = this.userPrefService.getFromSession(CompetitionHome.PrefKey);
        if (pref) {
        ...
        this.activeCompActions = [
            {
                ...
                deriveRouterLink: (data: Competition) => {
                    return ['/competition/details', '' + data.competitionId]
                }
            },
            {
                actionId    : 'monitor',
    ...
    savePreference() {
        this.userPrefService.setInSession(CompetitionHome.PrefKey, this.adminHomePref);
    }
